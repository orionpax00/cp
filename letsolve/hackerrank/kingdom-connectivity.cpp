...
#include "../../library/digraph.h"
#include "../../library/dfs_digraph.h"
#include "../../library/explore_digraph.h"
#include "../../library/debug.h"

void countPaths(int n, vector<vector<int>> edges) {
	int m = edges.size();
	explore_digraph<int> g(n);
	for(int i = 0; i < m; i++) g.add(--edges[i][0], --edges[i][1]);
	vector<int> order = g.toposort();
	if(order.size() == 0) puts("INFINITE PATHS");
	else cout << g.ans ;
}
